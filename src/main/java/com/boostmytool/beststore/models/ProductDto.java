...
public class ProductDto {
    ...
    public @Size(min = 10, message = "The description should be at least 10 caracters") @Size(max = 2000, message = "The description cannot exceed 2000 caracters") String getDescription() {
        return description;
    }

    public void setDescription(@Size(min = 10, message = "The description should be at least 10 caracters") @Size(max = 2000, message = "The description cannot exceed 2000 caracters") String description) {
